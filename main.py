...
🔑 กติกาวงเล็บ [ ] (สำคัญมาก): ครอบชื่อ "ฝั่งที่เป็นต่อ (favorite)" เท่านั้น — ปีกกาอยู่ฝั่งไหน = ให้เล่นฝั่งนั้น
   วิธีหาฝั่งต่อ: **ดูราคา 1X2 — ฝั่งไหน "น้ำ (odds/ราคา) น้อยกว่า" = ฝั่งต่อ** (เต็งกว่า ราคาต่ำกว่า) · ถ้าราคา 2 ฝั่งใกล้เคียงกันมาก = เสมอราคา (ไม่มีต่อรอง) ห้ามใส่วงเล็บ และกำกับท้ายว่า "⚠️ ไม่มีต่อรอง — ไม่ต้องเล่น"
