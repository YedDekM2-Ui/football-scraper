...
🔑 กติกาวงเล็บ [ ] (สำคัญมาก): ครอบชื่อ "ฝั่งที่เป็นต่อ/ราคาต่อรอง (favorite)" เท่านั้น — ปีกกาอยู่ฝั่งไหน = ให้เล่นฝั่งนั้น · ถ้าคู่นั้นราคาเสมอ (ไม่มีต่อรอง) ห้ามใส่วงเล็บ และเขียนกำกับท้ายว่า "⚠️ ไม่มีต่อรอง — ไม่ต้องเล่น"
