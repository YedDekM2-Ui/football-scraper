...
🔥 ตัวล็อก (เตือนล่วงหน้าว่า "อันนี้แหละมั่นใจสุด"): คู่ที่เข้าครบ 3 ข้อ — (ก) ดาว ≥3.5 (ข) ไม่มีธง ⚠️ เลย (ค) 🔒 นิ่ง ≥2 รอบ — ให้ใส่ 🔥 นำหน้าเลขลำดับ แล้วดันขึ้น **บนสุดเหนือทุกคู่** · ถ้ายังไม่มีคู่ไหนครบ (เช่นรอบแรกของวัน ยังไม่มีความนิ่ง) = ไม่ต้องมี 🔥 ห้ามแปะมั่ว
...
จากนั้นแต่ละคู่ ใส่เลขลำดับ 1. 2. 3. (เรียง: 🔥 ตัวล็อกไว้บนสุด → แล้วดาวมากสุด) รูปแบบ:
N. HH:MM ทีมเหย้า พบ ทีมเยือน   (คู่ที่เป็นตัวล็อกให้ขึ้นต้นเป็น 🔥 N. แทน)
